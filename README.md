...
> 当前统一版已集成下列 12 个型号，所有型号使用同一个 APK，不再按型号单独分发测试包。
...
| HUAWEI FreeBuds 4E | 扩展支持 | 电量、降噪 / 关闭与深度 / 均衡 / 轻度三档降噪、状态回读、左右耳双击与按住、佩戴检测、轻滑音量说明、3 种官方音效和官方配色图片 |
| HUAWEI FreeBuds 5 | 扩展支持 | 电量、降噪 / 关闭与状态回读、智慧动态 / 轻度 / 均衡三档降噪、佩戴检测、4 种官方音效、高清音质与低时延自动保持；手势设置待补充 |
| HUAWEI FreeBuds 6i | 扩展支持 | 电量、通透 / 降噪 / 关闭、4 档降噪、通透人声模式、双击 / 三击手势、低时延自动保持与专属图片 |
