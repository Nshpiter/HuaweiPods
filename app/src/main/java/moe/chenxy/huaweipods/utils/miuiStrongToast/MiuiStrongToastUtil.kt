package moe.chenxy.huaweipods.utils.miuiStrongToast
...
import moe.chenxy.huaweipods.utils.miuiStrongToast.data.Left
import moe.chenxy.huaweipods.utils.miuiStrongToast.data.Right
import moe.chenxy.huaweipods.utils.miuiStrongToast.data.StringToastBean
import moe.chenxy.huaweipods.utils.miuiStrongToast.data.TextParams
...
object MiuiStrongToastUtil {
    ...
    fun showStringToast(context: Context, text: String?, colorType: Int) {
        ...
        try {
            ...
            Log.e("HuaweiPods", "Failed to show HyperOS String Toast")
        }
    }
    ...
    fun showPodsBatteryToast(
        ...
        try {
            ...
            Log.e("HuaweiPods", "Failed to show Pods Battery Toast")
        }
    }
