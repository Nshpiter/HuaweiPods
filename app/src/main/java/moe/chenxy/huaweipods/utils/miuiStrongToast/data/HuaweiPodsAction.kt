...
object HuaweiPodsAction {
    ...
    const val EXTRA_FREECLIP2_BRIDGE_EQ_CUSTOM_IDS = "freeclip2_bridge_eq_custom_ids"
    const val EXTRA_FREECLIP2_BRIDGE_EQ_CUSTOM_NAMES = "freeclip2_bridge_eq_custom_names"
    const val EXTRA_FREECLIP2_BRIDGE_EQ_CUSTOM_GAINS = "freeclip2_bridge_eq_custom_gains"
    ...
    const val ACTION_HUAWEI_ANC_REFRESH = PREFIX + ".huawei_anc_refresh"
